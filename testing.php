   <?php
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = "INSERT INTO `content` (`topic_ID`, `topic_USERNAME`, `topic_DATE`, `topic_CREATORID`, `topic_REP`, `topic_NAME`, `topic_CONTENT`) VALUES (NULL, \'simondanerd\', CURRENT_TIMESTAMP, \'1\', \'1\', \'Tesasdft1\', $content)";
